// ==================================================================
// glyphs.js — Sistema de ícones inline (Lucide-style SVG paths).
// Carregado antes de data.js/app.js via <script src="glyphs.js">.
// Zero dependências; cada glyph é SVG com stroke-based (herda currentColor).
// ==================================================================
// Uso: innerHTML += glyph('utensils') ou glyph('coffee', 20, '#2B7A4B')
// Todos os paths vêm da biblioteca Lucide (lucide.dev, MIT license)
// e usam viewBox 24x24 com stroke-width 2.
...
const GLYPHS = {
  ...
  'activity':      '<path d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.5.5 0 0 1-.97 0L9.24 2.18a.5.5 0 0 0-.97 0L5.93 10.54A2 2 0 0 1 4 12H2"/>',
  'scale':         '<path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2"/>',
};

// Renderiza um glyph como SVG string.
// size: pixels (default 20). color: 'currentColor' ou um hex (default 'currentColor').
// stroke: largura do traço (default 2).
function glyph(name, size, color, stroke) {
  ...
  return '<svg xmlns="http://www.w3.org/2000/svg" width="' + s + '" height="' + s +
    '" viewBox="0 0 24 24" fill="none" stroke="' + c + '" stroke-width="' + sw +
